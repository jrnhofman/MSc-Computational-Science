...
############################################
# Modified version: In stead of the cops   #
# first moving randomly and then arresting #
# someone, they arrest and move to a rebel #
# without the random move first            #
# this should prevent cops from randomly   #
# moving away from active regions.         #
# If no active rebels in vision, move      #
# randomly and then look for an active.    #
############################################
...
#Save some data
savetxt('tmp/ac'+str(agentVision)+'_modc.dat',ac)
savetxt('tmp/ina'+str(agentVision)+'_modc.dat',ina)
savetxt('tmp/ja'+str(agentVision)+'_modc.dat',ja)

# stat('Figures/ac6_modc.dat','Figures/ina6_modc.dat','Figures/ja6_modc.dat')
