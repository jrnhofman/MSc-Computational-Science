...
###################################################
# Modified: Combination of the strategies in      #
# modified_agents.py and modified_cops.py         #
###################################################
    ...
    def act(self,vision,quad):
        ...
        if self.maxJail == -1:
            ...
            if self.active == 2:
                ...
                #Select the quadrant with the most active agents
...
#Save some data
savetxt('tmp/ac'+str(agentVision)+'_modac.dat',ac)
savetxt('tmp/ina'+str(agentVision)+'_modac.dat',ina)
savetxt('tmp/ja'+str(agentVision)+'_modac.dat',ja)
