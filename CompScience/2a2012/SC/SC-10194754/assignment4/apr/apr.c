...
int getparms(int argc, char *argv[])
{
	...
	if (MPI_SUCCESS != MPI_Bcast((double*)(&parms.threshold), 1, MPI_DOUBLE, 0, MPI_COMM_WORLD))
		return 2;
...
int parseargs(int argc, char* argv[])
{
    ...
    if(!parms.delta || !parms.ntotal || !parms.threshold) {
